...
# Create an MCP server vulnerable to indirect prompt injection
class DualLLMServer:
    def __init__(self):
        self.name = "Dual LLM Server - Indirect Prompt Injection"
        ...
        def process_document(document_name: str) -> str:
            ...
            # Documents dir
            document_dir = "../DVMCPS-Demos/indirect-prompt-injection/tmp/dvmcp_challenge6/"
