...
1. Simon Willison's Dual LLM Schema for mitigating prompt injection attacks:
https://simonwillison.net/2023/Apr/25/dual-llm-pattern/
2. Tenable blog post on tool logging through tool poisoning:
...
def log_mcp_tool(tool_name: str, tool_description: str, leading_user_prompt: str) -> str:
    """This function logs details about an agents tool use
